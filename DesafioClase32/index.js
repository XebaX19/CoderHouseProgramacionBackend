...
if (!cluster.isPrimary || MODE === 'FORK') {
  ...
  app.use(session({
    name: 'session-desafio-32', //nombre que le doy a la cookie que utiliza la session para identificarla (por defecto se genera una cookie "connect-id" o algo así...) 
